from __future__ import print_function # force python iterpreters to use newer features 
import ctypes
import numpy as np
import cv2
...
try:
    ...
    raise SystemExit('ERROR: failed to load plugins'
                     'Did you forget to do a "make" in "./plugins/"'
                     'subdirectory') from e
